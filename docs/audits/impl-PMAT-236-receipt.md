...
- `the_same_tree_gives_the_same_verdict_every_time` cannot prove determinism; it can only catch the pattern returning. The pipeline it guards is gone, not made reliable.
