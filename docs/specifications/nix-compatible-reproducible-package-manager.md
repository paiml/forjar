...
This specification has been restructured into per-phase files for easier navigation and status tracking.

**See**: [store/README.md](store/README.md) for the full table of contents with completion status.

| Phase | File | Status |
|-------|------|--------|
| A | [Store Model](store/phase-a-store.md) | ✅ |
