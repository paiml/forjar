...
// paiml/infra#208's EXECUTING observable test (binaries present vs deleted)
// now lives in `tests/falsification_cargo_observable_binary_status.rs`. It has
// to control `CARGO_HOME` since forjar#489 (the observable repairs PATH from
// it), and this file is at its 500-line ceiling.
