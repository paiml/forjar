...
///    malformed regardless of any hash, and this is the check a re-sealed
///    "zero the counters" edit still fails;
...
/// edited. This is the structural half of the defence: the seal alone is
/// unkeyed, so an editor who re-seals their edit would otherwise get a plan
/// that claims "0 changes" while listing several.
