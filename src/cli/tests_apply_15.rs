...
mod tests {
    ...
    fn test_fj506_apply_change_window_flag() {
        ...
        notify_json: false,
            ...
            notify_webhook_v2: None, notify_discord_webhook: None, notify_teams_webhook: None, notify_slack_blocks: None, notify_custom_template: None, notify_custom_webhook: None,
        });
        match cmd {
