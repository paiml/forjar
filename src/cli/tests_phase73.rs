...
mod tests {
    ...
    fn test_fj848_custom_webhook_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            custom_webhook: Some("https://hooks.example.com/forjar"), custom_headers: None, custom_json: None, custom_filter: None, custom_retry: None, custom_transform: None, custom_batch: None, custom_deduplicate: None, custom_throttle: None, custom_aggregate: None, custom_priority: None, custom_routing: None,
        };
