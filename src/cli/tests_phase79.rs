...
mod tests {
    ...
    fn test_fj896_custom_batch_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            custom_batch: Some("https://hooks.example.com|5"), custom_deduplicate: None, custom_throttle: None, custom_aggregate: None, custom_priority: None, custom_routing: None, custom_dedup_window: None, custom_rate_limit: None,        };
