...
pub(crate) fn dispatch_status_cmd(cmd: Commands) -> Result<(), String> {
    let Commands::Status(StatusArgs {
        ...
        machine_last_apply,
        fleet_drift_summary,
        resource_apply_duration,
        machine_resource_health,
        fleet_convergence_trend,
        ...
        machine_drift_age,
        fleet_failed_resources,
        resource_dependency_health,
        machine_resource_age_distribution,
        fleet_convergence_velocity,
        resource_failure_correlation,
        ...
        fleet_resource_convergence_streak,
        machine_resource_error_distribution,
        machine_resource_drift_age,
        fleet_resource_drift_age,
        machine_resource_recovery_rate,
        machine_resource_drift_velocity,
        fleet_resource_recovery_rate,
        machine_resource_convergence_efficiency,
        machine_resource_apply_frequency,
        fleet_resource_health_score,
        machine_resource_staleness_index,
        machine_resource_drift_recurrence,
        fleet_resource_drift_heatmap,
        machine_resource_convergence_trend_p90,
        machine_resource_drift_age_hours,
        fleet_resource_convergence_percentile,
        machine_resource_error_rate,
        machine_resource_convergence_gap,
        fleet_resource_error_distribution,
        machine_resource_convergence_stability,
