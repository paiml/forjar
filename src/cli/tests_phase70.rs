...
mod tests {
    ...
    fn test_fj824_teams_webhook_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            teams_webhook: Some("https://teams.webhook.office.com/test"), slack_blocks: None, custom_template: None, custom_webhook: None, custom_headers: None, custom_json: None, custom_filter: None, custom_retry: None, custom_transform: None, custom_batch: None, custom_deduplicate: None, custom_throttle: None,
        };
