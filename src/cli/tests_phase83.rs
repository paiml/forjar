...
mod tests {
    ...
    fn test_fj928_custom_priority_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            custom_priority: Some("https://hooks.example.com|default:high"), custom_routing: None, custom_dedup_window: None, custom_rate_limit: None, custom_backoff: None, custom_circuit_breaker: None, custom_dead_letter: None,        };
