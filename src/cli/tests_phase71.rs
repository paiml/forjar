...
mod tests {
    ...
    fn test_fj832_slack_blocks_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            slack_blocks: Some("https://hooks.slack.com/services/test"), custom_template: None, custom_webhook: None, custom_headers: None, custom_json: None,
        };
    ...
    fn test_fj832_slack_blocks_none() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            sqs: None, mattermost: None, ntfy: None, pagerduty: None,
            discord_webhook: None, teams_webhook: None,
            slack_blocks: None, custom_template: None, custom_webhook: None, custom_headers: None, custom_json: None,
        };
