...
/// PMAT-080: Generate a Nix flake with real version + checksums resolved
/// from the pinned release (spec F-3608/F-3610).
pub fn generate_nix(
    dist: &DistConfig,
    release: &super::dist_checksums::ResolvedRelease,
