...
mod tests {
    ...
    fn test_cov_validate_args_construct_all_fields() {
        let args = ValidateArgs {
            ...
            check_resource_when_condition_syntax: true, check_resource_lifecycle_hook_coverage: true, check_resource_secret_rotation_age: true, check_resource_dependency_chain_depth: true,
        };
    ...
    fn test_cov_validate_args_defaults() {
        let args = ValidateArgs {
            ...
            check_resource_when_condition_syntax: false, check_resource_lifecycle_hook_coverage: false, check_resource_secret_rotation_age: false, check_resource_dependency_chain_depth: false,
        };
        let debug = format!("{:?}", args);
        assert!(debug.contains("ValidateArgs"));
    }
    ...
    fn test_cov_graph_args_construct_all_fields() {
        let args = GraphArgs {
            ...
            resource_dependency_conditional_subgraph: true, resource_dependency_parallel_groups: true, resource_dependency_execution_cost: true,
        };
        let debug = format!("{:?}", args);
    ...
    fn test_cov_graph_args_defaults() {
        let args = GraphArgs {
            ...
            resource_dependency_conditional_subgraph: false, resource_dependency_parallel_groups: false, resource_dependency_execution_cost: false,
        };
        let debug = format!("{:?}", args);
        assert!(debug.contains("GraphArgs"));
    }
