...
mod tests {
    ...
    fn test_fj880_custom_retry_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            custom_retry: Some("https://hooks.example.com|retries:3"), custom_transform: None, custom_batch: None, custom_deduplicate: None, custom_throttle: None, custom_aggregate: None, custom_priority: None,
        };
