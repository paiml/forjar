...
fn send_discord_webhook_notification(
    url: Option<&str>,
    result: &Result<(), String>,
    config: &Path,
) {
...
fn send_custom_template_notification(
    template: Option<&str>,
    result: &Result<(), String>,
    config: &Path,
) {
...
fn send_custom_headers_notification(
    headers: Option<&str>,
    result: &Result<(), String>,
    config: &Path,
) {
...
fn send_custom_json_notification(
    template: Option<&str>,
    result: &Result<(), String>,
    config: &Path,
) {
...
fn send_custom_filter_notification(
    filter: Option<&str>,
    result: &Result<(), String>,
    config: &Path,
) {
