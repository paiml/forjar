...
mod tests {
    ...
    fn test_cov_status_args_construct_all_fields() {
        let args = StatusArgs {
            ...
            fleet_apply_success_rate_trend: true,
            machine_resource_drift_flapping: true,
            fleet_resource_type_drift_heatmap: true,
            machine_ssh_connection_health: true,
            lock_file_staleness_report: true,
            fleet_transport_method_summary: true,
            fleet_state_churn_analysis: true,
            config_maturity_score: true,
            fleet_capacity_utilization: true,
