...
mod tests {
    ...
    fn test_fj920_custom_aggregate_field() {
        let opts = super::super::dispatch_notify::NotifyOpts {
            ...
            custom_aggregate: Some("https://hooks.example.com|window_seconds:120"), custom_priority: None, custom_routing: None, custom_dedup_window: None, custom_rate_limit: None, custom_backoff: None, custom_circuit_breaker: None,        };
